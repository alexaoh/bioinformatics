...
\hlkwd{data}\hlstd{(crabs)}
\hlkwd{summary}\hlstd{(crabs[,}\hlnum{4}\hlopt{:}\hlnum{7}\hlstd{])}
\end{alltt}
\begin{verbatim}
##        FL              RW              CL              CW       
