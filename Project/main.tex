...
Also notice that both the forward and the Viterbi algorithms can easily be log-transformed in order to gain a higher numerical stability, by taking logarithms of all values and switching multiplications with additions. 
